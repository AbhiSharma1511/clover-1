  ...
  return (
    <div className="top-bar uk-flex uk-flex-between uk-flex-middle">
      <div className="uk-flex uk-flex-middle">
        <div
          className="profile border-2 rounded-full border-blue-400 border-2 flex justify-center items-center hover:border-blue-600"
          onClick={() => {
            setOver(true);
            setNav('rooms');
      ...
      <div className="nav">
        {(user.level === 'root' || user.level === 'admin') && (
          <div
            className={`text-xl p-[9px] hover:text-blue-600 cursor-pointer ${location.pathname.startsWith('/admin') ? ' active' : ''}`}
            onClick={() => {
              setOver(true);
        ...
        <div
          className="text-xl p-[9px] hover:text-blue-600 cursor-pointer mobile"
          onClick={() => {
            setOver(true);
            navigate('/', { replace: true });
          }}
        ...
        <div className="text-xl p-[9px] hover:text-blue-600 cursor-pointer" onClick={() => setPanel('createGroup')}>
          <FiPlusCircle />
        </div>
        <div
          className={`text-xl p-[9px] hover:text-blue-600 cursor-pointer${nav === 'settings' ? ' active' : ''}`}
          onClick={() => {
            setNav('settings');
          }}
        >
        ...
        <div className="uk-inline">
          <div className="text-xl p-[9px] hover:text-blue-600 cursor-pointer" type="button">
            <FiMoreHorizontal />
          </div>
